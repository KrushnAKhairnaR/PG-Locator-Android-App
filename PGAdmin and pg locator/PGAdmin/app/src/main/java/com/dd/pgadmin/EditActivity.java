...
public class EditActivity extends AppCompatActivity {
    ...
    public void RadioButtonDsiplay(){
        if(ac.equals("AC Room")){
           // rt1.setChecked(true);
            rg1.check(rg1.getChildAt(0).getId());
        }
        else{
           // rt11.setChecked(true);
            rg1.check(R.id.rbnac);
            rg1.check(rg1.getChildAt(0).getId());
        }

//        if(gym.equals("Gym")){
//           // rt2.setChecked(true);
//            rg2.check(R.id.rbgym);
//        }
//        else{
//            //rt22.setChecked(true);
//            rg2.check(R.id.rbngym);
//        }
//
//        if(food.equals("Food")){
//           // rt3.setChecked(true);
//            rg3.check(R.id.rbfood);
//        }
//        else{
//            //rt33.setChecked(true);
//            rg3.check(R.id.rbnfood);
//        }
//
//        if(fur.equals("Furniture")){
//           // rt4.setChecked(true);
//            rg4.check(R.id.rbfur);
//        }
//        else{
//            //rt44.setChecked(true);
//            rg4.check(R.id.rbnfur);
//        }
    }
